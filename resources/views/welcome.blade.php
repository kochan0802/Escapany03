    ...
    <head>
        ...
        <style>
            body {
                ...
                background-image: linear-gradient(to top, #fad0c4 0%, #ffd1ff 95%);
            }
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div style="display: flex; justify-content: center;">
     <img src="{{ asset('image/icon_es05.png') }}" alt="アイコン" style="width: 150px; height: auto;">
    </div>
    
    
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-pink-600 mb-4">コーチングサロン
      <br>「ESCAPANY」</h1>
       <br>
      <h2 class="sm:text-3xl text-2xl font-medium title-font text-gray-600 mb-4">人生迷子よ、みんなで逃げよ。</h2>
      
      
      <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
      <br>漠然と将来に不安を抱きながら、</br>まだ行動に移せていない人や、やる気はあるのに目的地がわからない人生迷子さん</br>
